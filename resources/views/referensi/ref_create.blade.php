...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Buat referensi</div>

                <div class="card-body">
            <form class="" action="{{ route('referensi.store') }}" method="post">
            {{ csrf_field() }}
            ...
            <div class="form-group has-feedback {{ $errors->has('sumber') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="sumber" placeholder="Post Title" value="{{ old('sumber') }}">
            ...
            <div class="form-group has-feedback {{ $errors->has('penulis') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="penulis" placeholder="Post Title" value="{{ old('penulis') }}">
